...
function showInput() {
    var message_entered =  document.getElementById("post").value;
...
<textarea title="What's on your mind?" name="post" id="post" style="height: 63px; width:590px;" placeholder="Whats on your mind?"></textarea>-->
<?php 
if(isset($_POST['post'])){
	if($_POST['p']!=NULL){
?>
